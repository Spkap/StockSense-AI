            ...
            if cached_analysis:
                ...
                return {
                    ...
                    "data": {
                        ...
                        "source": "cache",
                        "agent_type": "ReAct",
                        "overall_sentiment": cached_analysis.get("overall_sentiment", ""),
                        "overall_confidence": cached_analysis.get("overall_confidence", 0.0),
                        "confidence_reasoning": cached_analysis.get("confidence_reasoning", ""),
                        "headline_analyses": cached_analysis.get("headline_analyses", []),
                        "key_themes": cached_analysis.get("key_themes", []),
                        "potential_impact": cached_analysis.get("potential_impact", ""),
                        "risks_identified": cached_analysis.get("risks_identified", []),
                        "information_gaps": cached_analysis.get("information_gaps", []),
                        "skeptic_report": cached_analysis.get("skeptic_report", ""),
                        "skeptic_sentiment": cached_analysis.get("skeptic_sentiment", ""),
                        "skeptic_confidence": cached_analysis.get("skeptic_confidence", 0.0),
                        "primary_disagreement": cached_analysis.get("primary_disagreement", ""),
                        "critiques": cached_analysis.get("critiques", []),
                        "bear_cases": cached_analysis.get("bear_cases", []),
                        "hidden_risks": cached_analysis.get("hidden_risks", []),
                        "would_change_mind": cached_analysis.get("would_change_mind", []),
